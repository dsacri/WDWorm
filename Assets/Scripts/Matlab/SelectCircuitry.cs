...
/// </summary>
public class SelectCircuitry : MatlabUtil
{
    ...
    public SelectCircuitry(InputPackage package, out MatlabMatrix A_Glu, out MatlabMatrix A_ACh, out MatlabMatrix A_GABA, out MatlabMatrix A_extra, out MatlabMatrix A_el, out MatlabMatrix A_mon, out MatlabMatrix A_np, out MatlabMatrix S)
    {
        MatlabMatrix idxRemove = Fill(0, Length(package.A_el) - 1);
        idxRemove = idxRemove.Remove(package.idxNeurons);
        ...
        foreach (int i in idxRemove.ConvertToIntArray())
        {
